...
import cl.niclabs.skandium.impl.sequential.SequentialFor;
...
public class BubbleSort {
    ...
    public static void main(String[] args) {
        ...
        Function<ArrayList<Integer>, ArrayList<Integer>> bsort = new SequentialFor<>(
                new BSExecute(), in.size());

        long init = System.currentTimeMillis();

        ArrayList<Integer> out = bsort.apply(in);
        try {
